...
$t = [
  'es' => [
    ...
    'sections' => [
      ['Identificación del Titular', 'Proyectos MCE es la marca comercial de Marlon Carabalí, con domicilio en Colombia. Correo de contacto: <a class="text-blue-600 underline" href="mailto:contacto@proyectosmce.com">contacto@proyectosmce.com</a>.'],
      ['Condiciones de Uso', 'El acceso y uso de este sitio implican la aceptación de este Aviso Legal. El usuario se compromete a un uso lícito, diligente y de buena fe de los contenidos y servicios.'],
      ['Propiedad Intelectual e Industrial', 'Todo el contenido (textos, diseños, código, marcas y logotipos) pertenece a Proyectos MCE o a sus licenciantes. Se prohíbe su reproducción, distribución o transformación sin autorización expresa y escrita.'],
      ['Limitación de Responsabilidad', 'Aunque procuramos información precisa y servicios disponibles, no garantizamos ausencia total de errores o interrupciones. Proyectos MCE no será responsable por daños derivados del uso del sitio o de decisiones tomadas con base en su contenido.'],
      ['Enlaces Externos', 'Este sitio puede contener enlaces a terceros. Proyectos MCE no controla ni responde por su contenido o políticas. El usuario accede bajo su propia responsabilidad.'],
      ['Modificaciones', 'Nos reservamos el derecho de modificar este Aviso Legal y el contenido del sitio. Los cambios serán efectivos desde su publicación. Recomendamos revisarlo periódicamente.'],
      ['Legislación Aplicable', 'Este Aviso Legal se rige por las leyes de la República de Colombia. Las controversias se someterán a los jueces y tribunales competentes en Colombia.'],
    ],
