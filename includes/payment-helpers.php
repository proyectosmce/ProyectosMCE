...
function ensureProjectPaymentsSchema(mysqli $conn): void
{
    ...
    $missingColumns = [
        ...
        'cuotas_totales' => "ALTER TABLE proyecto_pagos ADD COLUMN cuotas_totales INT NULL AFTER forma_pago",
        'cuotas_pendientes' => "ALTER TABLE proyecto_pagos ADD COLUMN cuotas_pendientes INT NULL AFTER cuotas_totales",
        ...
        'deleted_at' => "ALTER TABLE proyecto_pagos ADD COLUMN deleted_at TIMESTAMP NULL DEFAULT NULL AFTER updated_at",
    ];
