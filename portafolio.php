            ...
            <div class="proyecto-item bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden border border-slate-100" data-categoria="<?php echo htmlspecialchars($project['categoria'], ENT_QUOTES, 'UTF-8'); ?>">
                ...
                <div class="p-6 space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <?php 
                        $isRealCase = isRealCaseProject($project);
                        ?>
                        <?php if (!$isRealCase): ?>
                            <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold i18n-pf-demo-case" data-i18n="pf-demo-case">Ejemplo demostrativo</span>
                        <?php else: ?>
