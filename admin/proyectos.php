        ...
        <aside id="sidebar" class="fixed lg:static z-40 inset-y-0 left-0 w-64 bg-white shadow-lg transform -translate-x-full lg:translate-x-0 transition-transform duration-200">
            ...
            <nav class="p-4">
                <ul class="space-y-2">
                    ...
                    <li><a href="proyectos.php" class="nav-link flex items-center space-x-2 rounded bg-blue-50 p-2 text-blue-600"><i class="fas fa-folder"></i><span>Proyectos</span></a></li>
                    ...
                    <li><a href="pagos.php" class="nav-link flex items-center space-x-2 p-2 hover:bg-gray-100 rounded"><i class="fas fa-receipt"></i><span>Pagos</span></a></li>
                    <li>
